...
export class WeatherReport extends Report {
    ...
    constructor(region: string, temperature: number, humidity: number) {
        super();
...
export class GradeReport extends Report {
    ...
    constructor(student: string, course: string, score: number) {
        let complete_string: string = "Grade for " + student + " in " + course;
        super();
        this.title = complete_string;
